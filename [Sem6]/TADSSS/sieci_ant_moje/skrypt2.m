...
figure(2)
GP1=plot(G1,'EdgeLabel',G1.Edges.Weight)
highlight(GP1,P3,'EdgeColor','g','LineWidth',4)
title(strcat('Najkrotsza sciezka dla funkcji kosztu 1, bez sprzê¿eñ K=',num2str(d3)))
figure(3)
GP2=plot(G2,'EdgeLabel',G2.Edges.Weight)
highlight(GP2,P4,'EdgeColor','g','LineWidth',4)
title(strcat('Najkrotsza sciezka dla funkcji kosztu 2, bez sprzê¿eñ K=',num2str(d4)))
figure(4)
GP2=plot(G2,'EdgeLabel',G2.Edges.Weight)
